  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">Balanced Mindset</h2>
        <p class="mt-3 text-gray-600">
          If you feel like a mess, remember that a star is just a big pile of
          space trash that pulled itself together and will shine for billions of
          years. Be messy like space trash and shine like the star you are~
        </p>
